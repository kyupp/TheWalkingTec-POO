...
public class DefensaMedioAlcance extends Defensa{
    ...
    public DefensaMedioAlcance(fPrincipal refPantalla, int ataquePorUnidad, int vida, int golpesPorSegundo, int nivel, int campos, int nivelDeApaicion, int alcance, String apariencia) {
